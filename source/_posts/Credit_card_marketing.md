...
for c in data_model:
    ...
    g.map(plt.hist, c, color = "red")
```
![Profiling of the final clusters](/images/clustering/facet_grid_2_1.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_2.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_3.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_4.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_5.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_6.PNG)
![Profiling of the final clusters](/images/clustering/facet_grid_2_7.PNG)
...
Until then, keep looking which cluster you belong to, if you owen a Credit Card.
